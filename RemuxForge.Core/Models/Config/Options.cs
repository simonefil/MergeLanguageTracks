    ...
    public class Options
    {
        ...
        public static Options Parse(string[] args)
        {
            ...
            while (i < args.Length && options.ErrorMessage.Length == 0)
            {
                ...
                if (key == "framesync-diagnostics")
                {
                    options.FrameSyncDiagnostics = true;
                    i++;
                    continue;
                }
                if (key == "deep-analysis-diagnostics")
                {
        ...
        /// </summary>
        /// <param name="value">Valore input</param>
        /// <returns>Modalita' normalizzata o stringa vuota se invalida</returns>
